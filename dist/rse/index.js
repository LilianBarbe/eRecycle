...
(() => {
  ...
  gsapWithCSS.fromTo(
    ".recon_list img, .split_visual_wrap img",
    {
      opacity: 0,
      scale: 1
      // Slightly larger than normal size for the initial zoom
    },
    {
      opacity: 1,
      scale: 1.1,
      // Slightly smaller than normal size for the zoom out effect
      scrollTrigger: {
      ...
      ease: "power1.out",
      onComplete: () => {
        gsapWithCSS.to(".recon_list img", {
          scale: 1,
          // Normal size after the effect
          duration: 2,
          ease: "power1.out"
        });
      }
  ...
  var updateCounter2 = () => {
    document.querySelector(".conversion_numbers_item .is-2").innerText = `${Math.round(counter2.value)}`;
  };
  gsapWithCSS.to(counter1, {
    value: 94,
    scrollTrigger: {
